 ...
 */
final class Version20250331095202 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_blocked (user_source INT NOT NULL, user_target INT NOT NULL, INDEX IDX_8258F58A3AD8644E (user_source), INDEX IDX_8258F58A233D34C1 (user_target), PRIMARY KEY(user_source, user_target)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
