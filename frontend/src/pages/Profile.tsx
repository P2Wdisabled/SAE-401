      ...
      <div className="mt-16 px-4">
        ...
        <div className="mt-4 flex flex-row items-center gap-2">
          {profile.editable ? (
            <>
              <Button
                object={<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <Button
                ...
                moreClasses=" bg-transparent text-white px-4 py-2 rounded mt-2"
              />
            </>
          ) : (
          ...
          {profile.editable && pinnedTweet && (
            <div className="mt-4 px-4">
              ...
              <div className="mb-4">
                ...
                />
                <Button
                object={<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M17.5 18L2 2" stroke="black" strokeWidth="2"/>
                  </svg>
